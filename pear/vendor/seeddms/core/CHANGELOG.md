6.0.34 (2025-07-02)
---------------------
- all changes from 5.1.41 merged
- getRevisionStatus() can return array with statistics

6.0.33 (2025-05-22)
---------------------
- all changes from 5.1.40 merged
...
5.1.41 (2025-07-29)
---------------------
- trim only none null field values
- getReviewerStatus() and getApprovalStatus() can return statistics array
- add methods SeedDMS_Core_DocumentContent::setOriginalFileName() and
  SeedDMS_Core_DocumentContent::checkOriginalFileName()
- add method SeedDMS_Core_File::checkFilename()
